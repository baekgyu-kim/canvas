...
public class CircleButton extends PaletteButton {
    ...
    public void createShape() {
        addActionListener(e -> {
            int id = seq;int xPos = 300; int yPos = 250; int width = 100; int height = 100; Color color = Color.green; int opacity = 50;int zOrder = seq; boolean shadow = false;boolean frame =false;
